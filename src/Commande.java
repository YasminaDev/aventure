...
public class Commande {
	 ...
	 */
	public Commande(String motCommande, String secondMot, String dernierMot) {
	...
	/**
	 *  Renvoie le dernier mot de cette Commande ou null si cette commande ne
	 *  possède pas de dernier mot.
	 *
	 * @return    le dernier mot de cette Commande ou null
	 */
	...
	/**
	 *  Teste si cette commande possède un dernier mot.
	 *
	 * @return    true si cette commande possède un dernier mot ; false sinon
	 */
	public boolean aDernierMot() {
		return (dernierMot != null);
	}
}
